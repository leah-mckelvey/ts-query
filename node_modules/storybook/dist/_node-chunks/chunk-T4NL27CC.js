...
import {
  versions_default
} from "./chunk-ZQTC4IMW.js";
import {
  require_picomatch
} from "./chunk-WIXJW6LA.js";
import {
  logger
} from "./chunk-V4R3AYR4.js";
import {
  any,
  from,
  invariant,
...
async function loadEnvs(options = {}) {
  let { getEnvironment } = await import("./lib-VKFW2NW5.js"), defaultNodeEnv = options.production ? "production" : "development", env2 = {
...
async function scanAndTransformFiles({
  ...
  let globby = (await import("./globby-EBHKFBTA.js")).globby, sourceFiles = await globby([glob2], {
    ...commonGlobOptions(""),
    ignore: ["**/node_modules/**"],
    dot: !0,
    cwd: getProjectRoot(),
...
var transformImportFiles = async (files, renamedImports, dryRun) => {
  let errors = [], { default: pLimit } = await import("./p-limit-5QMUSCN6.js"), limit = pLimit(10);
  return await Promise.all(
    files.map(
      (file) => limit(async () => {
        try {
